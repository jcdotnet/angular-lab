...
export class ProjectsService {
    ...
    constructor() {
        this.projects = [
            { nombre: 'Varios', name: 'Misc', descripcion: 'Proyectos en diferentes tecnologías dirigidos a particulares y empresas', description: 'Projects covering several technologies targeted to companies and individuals', tecnologias: 'Web, CSS, JS, PHP, WordPress...', cliente: '+20', fechaInicio: '2016-01-01', fechaFin: null, freelance: "true" }, 
            {nombre: 'Social Sharing Buttons and Counters', name: 'Social Sharing Buttons and Counters', descripcion: 'Plugin para compartir en redes sociales. Más info en el directorio de WordPress', description: 'A lightweight SEO-friendly plugin that allows you to share your posts and get more traffic.',tecnologias: 'HTML, PHP, WordPress', cliente: 'JC', fechaInicio: '2017-04-07', fechaFin: null, freelance: false }, 
            {nombre: 'Aplicación Web', name: 'Web application', descripcion: 'Migración de mi web personal a Angular 2 (y actualizada a la versión final).', description: 'Website migration to Angular 2 (October 4th: updated to final version).',tecnologias: 'HTML, JavaScript, Bootstrap, Angular', cliente: 'JC', fechaInicio: '2016-09-02', fechaFin: '2016-09-06', freelance: false }, 
            ...
            { nombre: 'Desarrollo en WordPress', name: 'WordPress development', descripcion: 'Cambios y corrección de errores en plugins existentes en WordPress', description: 'Existing WordPress plugins adaptation to client needs', tecnologias: 'HTML, CSS, PHP, WordPress', cliente: '+2', fechaInicio: '2015-11-14', fechaFin: '2016-02-29', freelance: false },
